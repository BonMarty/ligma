...
export function Accordion({ title, children }: AccordionProps) {
  return (
    <div className="ui:group ui:relative">
      ...
      <i className="ui:absolute ui:top-0 ui:right-0 ui:cursor-pointer ui:inline-block ui:not-italic ui:text-3xl ui:transition-all ui:duration-300 ui:peer-checked:rotate-45 ui:group-hover:text-white">&#43;</i>
